...
function Footer() {
  return (
    <section className='flex flex-col bg-black-100 h-30 py-2'>
      {/* heading */}
      <div className='flexCenter text-white regular-32 tracking-wide uppercase font-condiment'>Logo name</div>

      {/*  */}
      <div className='flex flex-col md:flex-row flexCenter'>
        ...
        {/* second column */}
        <div className='flex-col gap-2 py-2 flexEnd'>
              ...
              <p className='text-white regular-24'>Call Us: 7077404655</p>
              <p className='text-white regular-24'>Mail Us:pandaamitav01@gmail.com</p>
        </div>
